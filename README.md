...
- Mobile model selectors use the device-native select interaction behind the styled picker surface so touch selection remains reliable inside the fixed composer.
