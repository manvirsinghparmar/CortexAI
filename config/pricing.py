...
class ModelPricing:
    ...
    @classmethod
    def get_model_pricing(cls, model_type: str, model_name: str) -> Optional[Dict[str, float]]:
        """
    ...
    @classmethod
    def list_all_pricing(cls, model_type: Optional[str] = None) -> Dict[str, Dict[str, Dict[str, float]]]:
        """
