...
- Frontend follows the Alabaster Minimal shell: fixed left nav, top Ask/Compare tabs, prompt starter landing, horizontal compare canvas, unified composer with active model chips, and mobile Ask/Compare/History navigation.
